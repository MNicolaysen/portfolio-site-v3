export const projectsData = [
  ...
  },
  {
    ...
    tools:"React • JavaScript • CSS",
    dateCreated:'May 2023',
    description:"This is a travel journal web app that I created to put into practice, React props. It allowed me to dynamically display content and customize the app based on my experiences during a trip to Malaysia and Indonesia. Props helped me pass data between, promoting reusability and efficient code organization. This project highlighted the value of props in React development.",
  ...
  },
  {
    ...
    description:"I created this app early on, during my course with Scrimba. The app generates a random password when the button is clicked. It was a valuable learning experience for me as it allowed me to practice deploying a webpage using Netlify and gain a better understanding of the deployment process.",
  ...
  },
  {
    ...
    linkOne:"https://plan--swap.fly.dev/",
